        ...
        <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div className="rounded-[var(--radius)] border border-border bg-card shadow-[var(--shadow-card)] p-5">
                    ...
                    <TodoItem icon={<FileQuestionIcon className="h-[18px] w-[18px]" />} iconTint="red" title="Nộp Assignment OOP – Bài tập lớn chương 3" subtitle="Lập trình hướng đối tượng" badge={{ label: "Hạn hôm nay", variant: "destructive" }} dueTime="23:59" action="Nộp bài" actionVariant="primary" />
                    <TodoItem icon={<TerminalIcon className="h-[18px] w-[18px]" />} iconTint="red" title="Nộp Lab 1 – Build REST API với Claude Code" subtitle="Claude Code for BackEnd" badge={{ label: "Còn 4 giờ", variant: "warning" }} dueTime="22:00" action="Nộp bài" actionVariant="primary" />
                    <TodoItem icon={<HelpCircleIcon className="h-[18px] w-[18px]" />} iconTint="amber" title="Quiz Java - Quiz 2" subtitle="Lập trình Java" badge={{ label: "Còn 2 giờ", variant: "warning" }} dueTime="20:00" action="Làm quiz" />
                    <TodoItem icon={<BookOpenIcon className="h-[18px] w-[18px]" />} iconTint="blue" title="Đọc tài liệu trước buổi học" subtitle="Cơ sở dữ liệu" badge={{ label: "Ngày mai", variant: "info" }} dueTime="21/05" action="Xem ngay" />
                    <TodoItem icon={<CalendarClockIcon className="h-[18px] w-[18px]" />} iconTint="indigo" title="Lịch thi giữa kỳ CTDL&GT" subtitle="Cấu trúc dữ liệu và giải thuật" badge={{ label: "Ngày mai", variant: "info" }} dueTime="21/05" action="Xem lịch thi" />
                    <TodoItem icon={<CircleDollarSignIcon className="h-[18px] w-[18px]" />} iconTint="green" title="Đóng học phí học kỳ II" subtitle="Phòng Tài chính" badge={{ label: "Còn 5 ngày", variant: "success" }} dueTime="25/05" action="Thanh toán" />
                    <TodoItem icon={<FolderGit2Icon className="h-[18px] w-[18px]" />} iconTint="indigo" title="Đọc yêu cầu đồ án cuối kỳ" subtitle="Lập trình hướng đối tượng" badge={{ label: "Còn 20 ngày", variant: "success" }} dueTime="09/06" action="Xem ngay" />
                </div>
