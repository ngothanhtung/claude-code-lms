...
export function GreetingCard({ userName, semester, dateLabel = "Thứ 6, 29/05/2026" }: GreetingCardProps) {
    return (
        <Card className="flex-row items-center justify-between gap-4 rounded-[var(--radius)] border border-[hsl(243_50%_91%)] bg-[linear-gradient(180deg,#fff,#fff)] px-6 py-5 shadow-none ring-0" style={{
            ...
            <div className="flex items-center gap-3 rounded-xl border border-border bg-card px-4 py-3 shadow-[var(--shadow-sm)] text-primary">
                ...
                <div>
                    ...
                    <div className="text-[14px] font-bold text-foreground whitespace-nowrap">{dateLabel}</div>
                </div>
            </div>
        </Card>
    )
