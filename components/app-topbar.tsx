...
export function AppTopbar() {
    return (
        <header className="topbar">
            <Button className="icon-btn" variant="ghost" size="icon" aria-label="Thu gọn menu" type="button">
            ...
            <div className="topbar-right">
                <Button className="icon-btn" variant="ghost" size="icon" aria-label="Lịch" type="button">
                    <CalendarIcon className="icon-lg" />
                </Button>
                <Button className="icon-btn" variant="ghost" size="icon" aria-label="Thông báo" type="button">
                    <BellIcon className="icon-lg" />
                    <span className="dot-badge">6</span>
                </Button>
                <Button className="icon-btn" variant="ghost" size="icon" aria-label="Tin nhắn" type="button">
